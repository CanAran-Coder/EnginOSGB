...
function DashBoardApplicationList({ datas }: { datas: ApplicationType[] }) {
    ...
    const headers = ["Id", "Başvuru Tarihi", "Ad Soyad", "E-Posta", "Telefon", "Şehir", "Uzmanlık", "Sertifika", "Tecrübe", "CV"]

    return (<>


        <div className="shadow-2xl shadow-black/50 rounded-2xl border border-zinc-400 grid grid-cols-[1fr_4fr_6fr_5fr_5fr_2fr_5fr_3fr_2fr_2fr] place-items-center items-center p-5 min-w-150 mx-2 gap-y-4">
